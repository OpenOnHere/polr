...
<div class="self-container">
    ...
    <p class="self-text">
        现在你们看到的公测版，它完全基于Polr搭建而来。服务端使用最基本的LNMP架构，虽然使用了<a target="_blank" href="https://lumen.laravel.com/">为速度而生的Lumen框架</a>，但是我觉得性能上应该还有发挥的余地，留待日后慢慢优化。如果有前辈有提高性能的意见，还请不吝赐教，毕竟基建成本略高。
    </p>
    <p class="self-text">
    ...
    <p class="self-text">
        ...
        联系我闲扯或合作请邮件至 ecnu.yszc[AT]gmail.com (请更换[AT]为@) <br/>
